...
return Def.ActorFrame{
	Def.BitmapText {
		...
		Text="AutoPlayer",
		InitCommand=function(self) self:y(hasPersonalRecord and 6 or isVS() and 12 or 0):zoomx(0.6):zoomy(0.5):shadowlength(2*WideScreenDiff()):cropright(1):visible(not autoPlayer) end,
