return Def.ActorFrame{
	...
	Def.BitmapText {
		...
		InitCommand=function(self)
			self:x(isFinal() and SCREEN_CENTER_X or SCREEN_RIGHT-20*WideScreenDiff_(16/10)):y(isFinal() and 32*WideScreenDiff_(16/10) or 28*WideScreenDiff_(16/10)):shadowlength(2):halign(isFinal() and 0.5 or 1)
