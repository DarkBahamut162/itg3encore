return Def.ActorFrame{
	Def.StepsDisplayList{
		...
		CursorP1=loadfile(THEME:GetPathG('DifficultyList', 'cursor p1'))()..{ InitCommand=function(self) self:player(PLAYER_1) end },
		CursorP1Frame=Def.ActorFrame{ ChangeCommand=function(self) self:finishtweening():decelerate(0.15) end },
		CursorP2=loadfile(THEME:GetPathG('DifficultyList', 'cursor p2'))()..{ InitCommand=function(self) self:player(PLAYER_2) end },
