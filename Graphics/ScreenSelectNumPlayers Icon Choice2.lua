return Def.ActorFrame{
	...
	Def.ActorFrame{
		InitCommand=function(self) self:x(SCREEN_LEFT+111*WideScreenDiff()):y(SCREEN_CENTER_Y-95+120):horizalign(left) end,
		Def.Sprite {
		...
		Def.Sprite {
			Texture = THEME:GetPathG("_join","icons/versus_icon"),
