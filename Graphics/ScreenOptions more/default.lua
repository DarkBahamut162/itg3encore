return Def.ActorFrame{
	Def.Sprite {
		Texture = "_triangle "..(isFinal() and "final" or "normal"),
	...
	Def.ActorFrame{
		...
		Def.Sprite {
			Texture = "1 "..(isFinal() and "final" or "normal"),
		...
		Def.Sprite {
			Texture = "_ready "..(isFinal() and "final" or "normal"),
		...
		Def.Sprite {
			Texture = "_textglow "..(isFinal() and "final" or "normal"),
		...
		Def.Sprite {
			Texture = "2 "..(isFinal() and "final" or "normal"),
	...
	Def.ActorFrame{
		...
		Def.Sprite {
			Texture = "3 "..(isFinal() and "final" or "normal"),
			InitCommand=function(self) self:y(42):diffusealpha(0) end,
		...
		Def.Sprite {
			Texture = "4 "..(isFinal() and "final" or "normal"),
			InitCommand=function(self) self:y(62):diffusealpha(0) end,
			ExitSelectedP2Command=function(self) self:stoptweening():decelerate(0.2):y(52):diffusealpha(1) end,
