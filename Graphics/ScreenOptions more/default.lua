return Def.ActorFrame{
	LoadActor("_triangle")..{
		InitCommand=function(self) self:blend(Blend.Add):x(-38):diffuseblink():effectcolor1(color("0.6,0.6,0.6,1")):effectperiod(0.4):effect_hold_at_full(0.6):effectoffset(0.2):effectclock("beat") end,
	...
	Def.ActorFrame{
		InitCommand=function(self) self:x(-228+40):y(isTopScreen("ScreenWorkoutMenu") and 22 or (SCREEN_CENTER_Y+112 - THEME:GetMetric(Var "LoadingScreen","MoreY"))) end,
