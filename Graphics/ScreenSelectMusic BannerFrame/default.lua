...
return Def.ActorFrame{
	Def.ActorFrame{
		...
		LoadActor("frame "..(isFinal() and "final" or "normal"))..{
			InitCommand=function(self) self:x(SCREEN_CENTER_X+140):y(SCREEN_CENTER_Y-18) end,
		...
		LoadActor("flare")..{
			InitCommand=function(self) self:x(SCREEN_CENTER_X+142):y(SCREEN_CENTER_Y-18):blend(Blend.Add) end,
			OnCommand=function(self) self:diffusealpha(0) end,
			RefreshCommand=function(self) self:stoptweening(5):zoom(1):diffusealpha(1):sleep(0.1):accelerate(0.2):zoom(1.2):diffusealpha(0) end,
