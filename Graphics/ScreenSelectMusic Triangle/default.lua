local t = Def.ActorFrame{
	...
	LoadActor("outline")..{
		...
		GoLeftCommand=function(self) self:stoptweening():linear(0.1):diffusealpha(0):sleep(0.2):diffusealpha(1):cropright(-0.3):cropleft(1.1):fadeleft(0.05):faderight(0.05):diffusealpha(1):linear(0.72):cropright(1):cropleft(-0.3) end;
		GoRightCommand=function(self) self:stoptweening():linear(0.1):diffusealpha(0):sleep(0.2):diffusealpha(1):cropleft(-0.3):cropright(1.1):faderight(0.05):fadeleft(0.05):diffusealpha(1):linear(0.72):cropleft(1):cropright(-0.3) end;
		--]]
	};
};
