return Def.ActorFrame{
	LoadActor("wheel cursor glow")..{
		...
		CurrentSongChangedMessageCommand=function(self) self:stoptweening():linear(0.15):x(10*WideScreenDiff()):diffusealpha(0):decelerate(0.3):diffusealpha(1):x(0) end
	},
	LoadActor("glow")..{
		InitCommand=function(self) self:diffusealpha(0):zoom(WideScreenDiff()) end,
		...
		OffCommand=function(self) self:stoptweening():decelerate(0.3):diffusealpha(0) end,
		CurrentSongChangedMessageCommand=function(self) self:stoptweening():linear(0.15):x(10*WideScreenDiff()):decelerate(0.3):x(0) end
	},
	...
	LoadActor(THEME:GetPathG("","blueflare"))..{
		...
		RefreshCommand=function(self) self:stoptweening(1):zoom(0):diffusealpha(1):sleep(0.6):accelerate(0.5):zoom(5*WideScreenDiff()):diffusealpha(0) end,
