...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		BeginCommand=function(self)
			...
			if screen and faplus then
				...
				if showOffset and getenv("EvalComboP2") then
		...
		Def.BitmapText {
			...
			Condition=offsetInfo ~= nil and showOffset and getenv("EvalComboP2") and not isnan(average),
	...
	Def.ActorFrame{
		InitCommand=function(self) if WideScreenDiff_(1.4) < 1 and showOffset and getenv("EvalComboP2") then self:zoomx(5/6) end end,
		Name="JudgeFrames",
		Def.ActorFrame{
			Name="W0",
			Condition=faplus,
	...
	Def.ActorFrame{
		Condition=showOffset and getenv("EvalComboP2"),
