	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			LoadFont("_ScreenEvaluation numbers")..{
				InitCommand=function(self) self:x(158*WideScreenDiff()):y(-5):horizalign(left):diffuse(color("#0000FF")) end,
			...
			LoadFont("_ScreenEvaluation numbers")..{
				InitCommand=function(self) self:x(158*WideScreenDiff()):y(5):horizalign(left):diffuse(color("#FF0000")) end,
				OnCommand=function(self)
