...
credits[#credits+1] = LoadFont("_v credit")..{Text="Dalton Runberg"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Dominick Renzetti"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Jordan Frederick"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Mike Calfin"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Ryan Konkul"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Kyle Ward"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Chris Foy"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Ryan McKanna"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Matt Puls"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Jonas Casarino"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Christopher Emirzian"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="A.J. Kung"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="G. PolloxxX"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Max Leonardo Cerna"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Joseph DeGarmo"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Alex Sofikitis"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="N. Colley"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="J. Nordli"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Derek Bauer"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
...
credits[#credits+1] = LoadFont("_v credit")..{Text="GRIM.657"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Hellacious"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Kalek"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
...
credits[#credits+1] = LoadFont("_v credit")..{Text="neoMAXCML"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="SonGohanX"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
...
credits[#credits+1] = LoadFont("_v credit")..{Text="Infamous360's house - SC"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Great Wolf L. - Ontario, Canada"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Pittsburgh Mills - PA"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="North Park Club House - PA"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Game Zone - KS"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
...
credits[#credits+1] = LoadFont("_v credit")..{Text="Matt Vandermeulen"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Jeff 'Jeffrey' Odendahl"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Carlos 'Wanny' Ortega"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="John 'GooFWeaR' Uhlman"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="AJ Kelly"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Steve 'Nevets933' Bauer"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Derek 'Whicker' Bauer"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Scott 'Scooter' Smiesko"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Max Racaud"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Josh Laughery"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Ryan Jackson"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
...
credits[#credits+1] = LoadFont("_v credit")..{Text="Eric Holniker"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Tyler Thompson"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Janel Yeager"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Ryan Lower"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Joseph Sherman"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Kevin 'PF3K' Lin"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Michael Porter"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Brian 'Red' Kurtz"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Valentina O'Donnell"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Bryan Wills"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Brandon Stokes"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Brian Rudowski"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Ryan Campbell"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Jarad Kaplan"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Phil Eberhardt"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Chelsie Ehasz"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Adam Landes"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Patrick Richards"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Ian Hunsberger"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Carly Chiavaroli"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Huamid 'Moon' Alnuaimi"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Sonia Leng"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Garrett Shourds"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Bradley Shank"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Jorrie Marie"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
credits[#credits+1] = LoadFont("_v credit")..{Text="Jordan Miller"; OnCommand=function(self) self:horizalign(left):shadowlength(1.25) end;};
