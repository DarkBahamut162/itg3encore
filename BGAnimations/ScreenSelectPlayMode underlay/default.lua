return Def.ActorFrame{
	...
	LoadActor(THEME:GetPathB("ScreenWithMenuElements","underlay/back"))..{ OnCommand=function(self) self:playcommand("DoOn") end },
	LoadActor(THEME:GetPathB("_shared","underlay arrows"))..{ OnCommand=function(self) self:playcommand("DoOn") end },
