return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.Sprite {
			...
			InitCommand=function(self) self:x(SCREEN_LEFT+120*WideScreenDiff()):y(SCREEN_CENTER_Y+(155-20)*WideScreenDiff()):zoom(WideScreenDiff()):croptop(0.5):cropbottom(0.5) end,
		...
		Def.Sprite {
			...
			InitCommand=function(self) self:x(SCREEN_LEFT+60*WideScreenDiff()):y(SCREEN_CENTER_Y+(165-20)*WideScreenDiff()):zoom(WideScreenDiff()):diffusealpha(0) end,
		...
		Def.Sprite {
			...
			InitCommand=function(self) self:x(SCREEN_LEFT+120*WideScreenDiff()):y(SCREEN_CENTER_Y+(155-20)*WideScreenDiff()):zoom(WideScreenDiff()):cropleft(0.5):cropright(0.5) end,
		...
		Def.BitmapText {
			File = "_r bold 30px",
			Text="Player Name",
			InitCommand=function(self) self:x(SCREEN_LEFT+120*WideScreenDiff()):y(SCREEN_CENTER_Y+(87-20)*WideScreenDiff()):diffusetopedge(color("#fff000")):diffusebottomedge(color("#ffa500")):shadowlength(2):zoom(0.8*WideScreenDiff()):diffusealpha(0) end,
			OnCommand=function(self) self:sleep(5.4):linear(0.2):diffusealpha(1):sleep(4.4):linear(0.5):diffusealpha(0) end
		},
		Def.BitmapText {
			File = "_v profile",
			Text="Number of\nplayed songs",
			InitCommand=function(self) self:x(SCREEN_LEFT+148*WideScreenDiff()):y(SCREEN_CENTER_Y+(162-20)*WideScreenDiff()):shadowlength(2):zoom(0.8*WideScreenDiff()):diffusealpha(0) end,
		...
		Def.Sprite {
			...
			InitCommand=function(self) self:x(SCREEN_LEFT+242*WideScreenDiff()):y(SCREEN_CENTER_Y+(155-20)*WideScreenDiff()):zoom(WideScreenDiff()):addx(-54*WideScreenDiff()):cropleft(1) end,
		...
		Def.ActorFrame{
			...
			Def.Sprite {
				...
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*0-20)*WideScreenDiff()):animate(0):zoom(0) end,
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*0-20)*WideScreenDiff()):animate(0):diffusealpha(0) end,
		...
		Def.ActorFrame{
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*1-20)*WideScreenDiff()):animate(0):zoom(0) end,
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*1-20)*WideScreenDiff()):animate(0):diffusealpha(0) end,
		...
		Def.ActorFrame{
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*2-20)*WideScreenDiff()):animate(0):zoom(0) end,
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*2-20)*WideScreenDiff()):animate(0):diffusealpha(0) end,
		...
		Def.ActorFrame{
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*3-20)*WideScreenDiff()):animate(0):zoom(0) end,
			...
			Def.Sprite {
				Texture = THEME:GetPathB("","_overlay/awards"),
				InitCommand=function(self) self:x(SCREEN_LEFT+238*WideScreenDiff()):y(SCREEN_CENTER_Y+(103+34*3-20)*WideScreenDiff()):animate(0):diffusealpha(0) end,
