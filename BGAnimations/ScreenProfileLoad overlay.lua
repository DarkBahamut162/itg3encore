...
return Def.ActorFrame{
	OffCommand=function() if isOutFoxV043() and ThemePrefs.Get("SLFavorites") == 1 then SONGMAN:SetPreferredSongs(PROFILEMAN:GetProfile(GAMESTATE:GetMasterPlayerNumber()):GetGUID()) end end,
	Def.Quad{
