return Def.ActorFrame{
    ...
    loadfile(THEME:GetPathB("ScreenEndingOkay","overlay/credits"))(),
    Def.ActorFrame{
    ...
    loadfile(THEME:GetPathB("ScreenEndingOkay","overlay/intro"))()..{
        OnCommand=function(self) self:Center():sleep(20):addx(SCREEN_WIDTH*4) end
    },
    Def.Sprite {
        Texture = "../ScreenTitleMenu background/newlogo "..(isFinal() and "final" or "normal"),
    ...
    Def.Sprite {
        Texture = "../ScreenTitleMenu background/glow "..(isFinal() and "final" or "normal"),
    ...
    Def.Sprite {
        Texture = "../ScreenEndingGood underlay/thank you for playing",
