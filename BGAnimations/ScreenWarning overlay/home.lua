return Def.ActorFrame{
	InitCommand=function(self) self:fov(90):CenterX():y(SCREEN_CENTER_Y-20):addx(800):zoom(3.4*WideScreenDiff()):rotationx(90) end,
	...
	loadfile(THEME:GetPathG("_platform","home single"))()..{ InitCommand=function(self) self:addx(-56) end },
	loadfile(THEME:GetPathG("_platform","home single"))()..{ InitCommand=function(self) self:addx(56) end }
}