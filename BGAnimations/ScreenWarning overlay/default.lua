return Def.ActorFrame{
	loadfile(THEME:GetPathB("ScreenWarning","overlay/"..(IsHome() and "home" or "arcade")))()..{
	...
	Def.Sprite {
		Texture = THEME:GetPathG("_red2","streak "..(isFinal() and "final" or "normal")),
