...
local item_padding_start = 9/WideScreenDiff_(16/10)
...
creditScroller.BeginCommand=function(self)
	SCREENMAN:GetTopScreen():PostScreenMessage( 'SM_MenuTimer', (creditScroller.SecondsPerItem * (#creditScroller + item_padding_start) + 3.25/WideScreenDiff_(16/10)) )
end

return Def.ActorFrame{
	creditScroller..{
		InitCommand= function (self)
			self:CenterX():y(SCREEN_CENTER_Y-15):zoom(WideScreenDiff_(16/10))
		end
	}
}