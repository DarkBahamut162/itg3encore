...
return Def.ActorFrame{
	...
	LoadActor("up2")..{
		...
		OnCommand=function(self) self:sleep(0.9+(2.5*(length1*0.6/SCREEN_WIDTH))):diffusealpha(1)
	...
	LoadActor("up3")..{
		...
		OnCommand=function(self) self:sleep(0.9+(2.5*((SCREEN_WIDTH-length3)*0.6/SCREEN_WIDTH))):diffusealpha(1)
