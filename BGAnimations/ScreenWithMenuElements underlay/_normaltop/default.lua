return Def.ActorFrame{
	...
	Def.Sprite {
		...
		InitCommand=function(self) self:x((isEtterna() or isFinal()) and SCREEN_LEFT or 180*WideScreenDiff()):zoom(WideScreenDiff()):valign(0):halign(0):zoomtowidth(SCREEN_WIDTH) end,
		OnCommand=function(self) self:y(SCREEN_TOP-100):decelerate(0.8):y(SCREEN_TOP) end,
		OffCommand=function(self) self:accelerate(0.5):addy(-100) end
	},
	Def.Sprite {
