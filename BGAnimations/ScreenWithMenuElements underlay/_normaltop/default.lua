return Def.ActorFrame{
	...
	LoadActor("up2")..{
		...
		OnCommand=function(self) self:queuecommand("Animate") end,
		AnimateCommand=function(self) self:sleep(0.9+(2.5*(180*0.6/SCREEN_WIDTH))):diffusealpha(1)
	...
	LoadActor("up3")..{
		...
		OnCommand=function(self) self:queuecommand("Animate") end,
		AnimateCommand=function(self) self:sleep(0.9+(2.5*((SCREEN_WIDTH-450)*0.6/SCREEN_WIDTH))):diffusealpha(1)
