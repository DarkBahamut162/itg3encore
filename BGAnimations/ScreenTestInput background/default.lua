...
return Def.ActorFrame{
	...
	LoadActor(THEME:GetPathB("ScreenWithMenuElements background/CJ112",isFinal() and "Final" or "Normal"))..{
	...
	Def.ActorFrame{
		...
		LoadActor("right button")..{ InitCommand=function(self) self:x(-70):zoomx(-1) end },
		LoadActor("start glow")..{
