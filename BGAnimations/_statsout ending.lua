return Def.ActorFrame{
    Def.ActorFrame{
		...
		LoadActor(THEME:GetPathB("","_overlay/awards"))..{
			...
			OnCommand=function(self) self:animate(0):zoom(0):sleep(1.35+0.5):playcommand("Update") end,
			UpdateCommand=function(self,parent) StarIcon(self, PLAYER_1) self:bounceend(0.4):zoom(0.55) end
		},
		LoadActor(THEME:GetPathB("","_overlay/awards"))..{
			InitCommand=function(self) self:x(SCREEN_LEFT+235):y(SCREEN_CENTER_Y+103+34*1) end,
			OnCommand=function(self) self:animate(0):zoom(0):sleep(1.40+0.5):playcommand("Update") end,
			UpdateCommand=function(self,parent) QuadIcon(self, PLAYER_1) self:bounceend(0.4):zoom(0.55) end
		},
		LoadActor(THEME:GetPathB("","_overlay/awards"))..{
			InitCommand=function(self) self:x(SCREEN_LEFT+238):y(SCREEN_CENTER_Y+103+34*2) end,
			OnCommand=function(self) self:animate(0):zoom(0):sleep(1.45+0.5):playcommand("Update") end,
			UpdateCommand=function(self,parent) PercentIcon(self, PLAYER_1) self:bounceend(0.4):zoom(0.55) end
		},
		LoadActor(THEME:GetPathB("","_overlay/awards"))..{
			InitCommand=function(self) self:x(SCREEN_LEFT+238):y(SCREEN_CENTER_Y+103+34*3) end,
			OnCommand=function(self) self:animate(0):zoom(0):sleep(1.50+0.5):playcommand("Update") end,
			UpdateCommand=function(self,parent) CalorieIcon(self, PLAYER_1) self:bounceend(0.4):zoom(0.55) end
		}
    },
    Def.ActorFrame{
		...
		LoadActor(THEME:GetPathB("","_overlay/achpane"))..{
			InitCommand=function(self) self:x(SCREEN_RIGHT-242):y(SCREEN_CENTER_Y+155):zoomx(-1) end,
