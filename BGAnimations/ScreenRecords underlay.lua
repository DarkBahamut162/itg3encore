return Def.ActorFrame{
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenTitleMenu","background/_lower"),
	...
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenTitleMenu","background/_upper"),
		InitCommand=function(self) self:Center():zoomtowidth(SCREEN_WIDTH):diffusealpha(0.4):blend(Blend.Add) end,
		OnCommand=function(self) self:queuecommand("Anim") end,
		AnimCommand=function(self) self:croptop(-0.8):cropbottom(1):fadebottom(0.45):fadetop(0.45):linear(3):croptop(1):cropbottom(-0.8):sleep(1):queuecommand("Anim") end
	},
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenTitleMenu","background/_lside"),
	...
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenTitleMenu","background/width"),
		Condition=not isFinal(),
	...
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenTitleMenu","background/base final"),
		Condition=isFinal(),
