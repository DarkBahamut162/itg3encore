return Def.ActorFrame{
	...
	LoadFont("_v 26px bold black")..{
		InitCommand=function(self) self:CenterX():y(isFinal() and SCREEN_BOTTOM-12 or SCREEN_BOTTOM-16):diffusealpha(0):shadowlength(0):zoom(0.5) end,
	...
	LoadActor("updatecoin")..{
		InitCommand=function(self) self:CenterX():y(SCREEN_BOTTOM-16):diffusealpha(0):shadowlength(2):zoom(0.5) end,
	...
	Def.ActorFrame{
		...
		LoadFont("_v 26px bold black")..{
			InitCommand=function(self) self:shadowlength(2):zoom(0.5):playcommand("Set") end,
