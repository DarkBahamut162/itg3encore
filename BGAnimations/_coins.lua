...
return Def.ActorFrame{
	...
	Def.BitmapText {
		...
		RefreshCommand=function(self)
			if IsNetSMOnline() or isOutFoxOnline() or isITGmaniaOnline() then if not isGamePlay() then self:settext('ONLINE MODE') end return end
	...
	Def.Sprite {
		Texture = THEME:GetPathG("","updatecoin"),
