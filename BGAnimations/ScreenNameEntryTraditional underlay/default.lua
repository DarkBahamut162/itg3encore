return Def.ActorFrame{
	...
	Def.Sprite {
		Texture = "name entry banner mask",
	...
	Def.ActorFrame{
		...
		Def.Sprite {
			Texture = "name frame "..(isFinal() and "final" or "normal"),
		...
		Def.Sprite {
			Texture = "name entry "..(isFinal() and "final" or "normal").." BGA score frame",
		...
		Def.Sprite {
			Texture = "name entry "..(isFinal() and "final" or "normal").." BGA list frame",
