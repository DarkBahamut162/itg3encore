...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_base bpm")..{ InitCommand=function(self) self:x(SCREEN_CENTER_X-3*WideScreenDiff()):y(SCREEN_TOP+58*WideScreenDiff()):zoom(WideScreenDiff()):visible(not isVS()) end },
