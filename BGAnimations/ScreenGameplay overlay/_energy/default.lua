local t = Def.ActorFrame{
	Def.ActorFrame{
		...
		Def.SongMeterDisplay{
			InitCommand=cmd(SetStreamWidth,292;blend,Blend.Add);
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight")..{
			...
			OnCommand=cmd(sleep,1.8;linear,.4;diffusealpha,1;diffuse,color("#FF0000"));
		};
		LoadActor("width")..{
			InitCommand=cmd(x,SCREEN_CENTER_X-190;y,SCREEN_TOP+24;halign,1;zoomtowidth,3);
			OnCommand=cmd(sleep,1.5;linear,.1;zoomtowidth,SCREEN_WIDTH/2-206);
		};
		LoadActor("width")..{
		...
		LoadActor("_neons")..{
			...
			--effectdelay,0.5;
			OnCommand=cmd(effectclock,'beat';diffuseramp;effectcolor1,color("#680303");effectcolor2,color("#f11e1e");effectperiod,0.5;effectoffset,0.05;diffusealpha,0;linear,.4;diffusealpha,1;);
		};
		LoadActor("_neons")..{
			InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_TOP+24);
			--effectdelay,0.5;
			OnCommand=cmd(effectclock,'beat';diffuseramp;effectcolor1,color("#973636");effectcolor2,color("#f11e1e");effectperiod,0.5;effectoffset,0.05;diffusealpha,0;linear,.4;diffusealpha,1;);
		};
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			TweenOffCommand=cmd(stoptweening;accelerate,0.8;addx,-SCREEN_WIDTH/3);
