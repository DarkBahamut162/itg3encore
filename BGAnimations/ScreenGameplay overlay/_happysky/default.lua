...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		InitCommand=function(self) self:y(-5/WideScreenDiff()) end,
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/_ONLY_P1"))()..{
		...
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/_ONLY_P2"))()..{
			InitCommand=function(self) self:x(0):y(0) end,
			Condition=GAMESTATE:IsPlayerEnabled(PLAYER_2) and not GAMESTATE:IsPlayerEnabled(PLAYER_1)
		},
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/_VERSUS"))()..{
			InitCommand=function(self) self:x(0):y(0) end,
			Condition=GAMESTATE:IsPlayerEnabled(PLAYER_1) == GAMESTATE:IsPlayerEnabled(PLAYER_2)
		},
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/_BANNER"))()..{
			InitCommand=function(self) self:CenterX():y(441):zoom(WideScreenDiff()):zoom(WideScreenDiff()) end
		}
	},
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/_LIFE_P1"))()..{
		InitCommand=function(self) self:x(SCREEN_CENTER_X-181*WideScreenDiff()):y(22*WideScreenDiff()):zoom(WideScreenDiff()) end
	},
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/_LIFE_P2"))()..{
		InitCommand=function(self) self:x(SCREEN_CENTER_X+181*WideScreenDiff()):y(22*WideScreenDiff()):zoom(WideScreenDiff()) end
	},
	...
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenGameplay","overlay/_happysky/BPM"),
	...
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/DIFFICULTY"))(GAMESTATE:GetMasterPlayerNumber())..{
		InitCommand=function(self) self:x(SCREEN_CENTER_X-320*WideScreenDiff()):y(-16) end
	},
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/STAGE"))()..{
		InitCommand=function(self) self:x(SCREEN_CENTER_X-320*WideScreenDiff()):y(-16) end
	},
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_happysky/TIME_DISPLAY"))()..{
