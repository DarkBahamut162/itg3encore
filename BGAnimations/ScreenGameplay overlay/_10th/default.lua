...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_10th/_ONLY_P1"))()..{
	...
	Def.Sprite {
		Texture = THEME:GetPathB("ScreenGameplay","overlay/_10th/BPM"),
	...
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_10th/DIFFICULTY"))(GAMESTATE:GetMasterPlayerNumber())..{
		InitCommand=function(self) self:x(SCREEN_CENTER_X-336*WideScreenDiff()):y(-17) end
	},
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_10th/STAGE"))()..{
		InitCommand=function(self) self:x(SCREEN_CENTER_X-302*WideScreenDiff()):y(-17) end
	},
	loadfile(THEME:GetPathB("ScreenGameplay","overlay/_10th/TIME_DISPLAY"))()..{
		InitCommand=function(self) self:CenterX():y(17*WideScreenDiff()):zoomx(WideScreenDiff()):zoomy(0.8*WideScreenDiff()) end
	}
}
