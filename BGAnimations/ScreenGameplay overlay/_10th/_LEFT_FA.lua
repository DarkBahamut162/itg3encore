return Def.ActorFrame{
	...
	Def.BitmapText {
		...
		InitCommand=function(self) self:x(37.5):y(31):zoomx(1.125):horizalign(right) end,
		Text="     0",
	...
	Def.BitmapText {
		...
		InitCommand=function(self) self:x(37.5):y(48):zoomx(1.125):horizalign(right) end,
		Text="     0",
