local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.SongMeterDisplay{
			...
			Tip=LoadActor("tip")..{
				OnCommand=function(self) self:zoom(0):y(-1):sleep(1.8):zoom(1):diffuseshift():effectcolor1(color("1,1,1,1")):effectcolor2(color("1,1,1,.5")):effectclock("beat"):effectperiod(4) end;
			};
		};
	};
	Def.ActorFrame{
