local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.SongMeterDisplay{
			...
			Tip=LoadActor("tip")..{
				OnCommand=function(self) self:zoom(0):y(-1):sleep(1.8):zoom(1):diffuseshift():effectcolor1(color("1,1,1,1")):effectcolor2(color("1,1,1,0.5")):effectclock("beat"):effectperiod(4) end;
			};
		};
	};
	Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight2")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+50):visible(GAMESTATE:GetPlayMode() ~= 'PlayMode_Rave') end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#FFFFFFFF")):effectperiod(1):effectoffset(0):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
		LoadActor("width")..{
		...
		LoadActor("base.png")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+24-2.5) end; };
		LoadActor("bpmbasea")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+64-4.5):visible(GAMESTATE:GetPlayMode() ~= 'PlayMode_Rave') end; };
		LoadActor("_neons")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+24):blend(Blend.Add) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#474747")):effectcolor2(color("##EEEEEE")):effectperiod(1):effectoffset(0.05):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
		LoadActor("_neons")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+24) end;
		...
		LoadActor("_neon2")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+44):blend(Blend.Add):visible(GAMESTATE:GetPlayMode() ~= 'PlayMode_Rave') end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#474747")):effectcolor2(color("##EEEEEE")):effectperiod(1):effectoffset(0.05):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
		LoadActor("_neon2")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+44):visible(GAMESTATE:GetPlayMode() ~= 'PlayMode_Rave') end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#FFFFFFFF")):effectperiod(1):effectoffset(0.05):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
