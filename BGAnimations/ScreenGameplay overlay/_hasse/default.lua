return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight bottom")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+50):visible(not isRave()) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#FFFFFFFF")):effectperiod(0.5):effect_hold_at_full(0.5):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
		LoadActor("width")..{
		...
		LoadActor("_base normal")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+24-2.5) end; };
		LoadActor("_base bpm")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+64-4.5):visible(not isRave()) end; };
		...
		LoadActor("_neons bottom")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+44):blend(Blend.Add):visible(not isRave()) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#474747")):effectcolor2(color("##EEEEEE")):effectperiod(0.5):effect_hold_at_full(0.5):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
		LoadActor("_neons bottom")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+44):visible(not isRave()) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#FFFFFFFF")):effectperiod(0.5):effect_hold_at_full(0.5):diffusealpha(0):linear(0.4):diffusealpha(1) end;
		};
