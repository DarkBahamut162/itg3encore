...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			LoadActor("_base bpm "..(isFinal() and "final" or "normal"))..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP+58*WideScreenDiff()):zoom(WideScreenDiff()):visible(not isVS()) end },
