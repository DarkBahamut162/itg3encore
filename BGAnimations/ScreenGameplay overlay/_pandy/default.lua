...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("width")..{
			InitCommand=function(self) self:x(SCREEN_CENTER_X-190*WideScreenDiff()):y(SCREEN_TOP+22*WideScreenDiff()):halign(1):zoomtowidth(3*WideScreenDiff()) end,
			OnCommand=function(self) self:sleep(1.5):linear(0.1):zoomtowidth(SCREEN_WIDTH/2-200*WideScreenDiff()) end
		},
		LoadActor("width")..{
			InitCommand=function(self) self:x(SCREEN_CENTER_X+190*WideScreenDiff()):y(SCREEN_TOP+22*WideScreenDiff()):halign(0):zoomtowidth(3*WideScreenDiff()) end,
			OnCommand=function(self) self:sleep(1.5):linear(0.1):zoomtowidth(SCREEN_WIDTH/2-200*WideScreenDiff()) end
		},
		LoadActor("left")..{
		...
		LoadActor("_base bpm")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP+57*WideScreenDiff()):zoom(WideScreenDiff()):visible(not isRave()) end },
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			TweenOffCommand=function(self) self:accelerate(0.8):addx(SCREEN_WIDTH/2) end,
			LoadActor("_difficulty icons")..{
				InitCommand=function(self) self:pause():zoomx(-1*WideScreenDiff()):playcommand("Update") end,
				UpdateCommand=function(self)
