local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight2")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+40):blend(Blend.Add) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#007892")):effectcolor2(color("#00EAFF")):effectperiod(1):effectoffset(0):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("_uplight2")..{
			InitCommand=function(self) self:x(SCREEN_CENTER_X):y(SCREEN_TOP-2+40) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#82f5ff")):effectperiod(1):effectoffset(0):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("width")..{
		...
		LoadActor("base.png")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+40) end; };
		LoadActor("_neons")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+24):blend(Blend.Add) end;
