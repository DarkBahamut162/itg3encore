return Def.ActorFrame{
	...
	Def.BitmapText {
		...
		InitCommand=function(self) self:x(71):y(30):horizalign(right):zoomx(0.95):zoomy(0.85) end,
		Text="     0",
	...
	Def.BitmapText {
		...
		InitCommand=function(self) self:x(71):y(44):horizalign(right):zoomx(0.95):zoomy(0.85) end,
		Text="     0",
