return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.Sprite {
			...
			InitCommand=function(self) self:rotationz(180):diffuse(.3,.3,.3,1):x(8):y(-1):visible((GAMESTATE:IsPlayerEnabled(PLAYER_2))) end
		},
		Def.ActorFrame{
			Condition=getenv("IIDXLife"..pname(PLAYER_2)) or isTopScreen("ScreenDemonstration"),
			Def.Sprite {
				Texture = "../life/"..IIDXLifeBar(PLAYER_2),
				InitCommand=function(self) self:rotationz(180):x(8):y(-1):visible((GAMESTATE:IsPlayerEnabled(PLAYER_2))) end,
				LifeChangedMessageCommand=function(self,param)
					if param.Player == PLAYER_2 then
						local life = param.LifeMeter:GetLife()
