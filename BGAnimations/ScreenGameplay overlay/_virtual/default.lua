...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		InitCommand=function(self) self:CenterX():y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()):addy(-100) end,
	...
	Def.ActorFrame{
		InitCommand=function(self) self:CenterX():y(SCREEN_TOP+27*WideScreenDiff()):zoom(WideScreenDiff()):addy(-100) end,
		OnCommand=function(self) self:sleep(0.5):queuecommand("TweenOn") end,
		OffCommand=function(self) self:queuecommand("TweenOff") end,
		TweenOnCommand=function(self) self:decelerate(0.8):addy(100) end,
		TweenOffCommand=function(self) if AnyPlayerFullComboed() then self:sleep(1) end self:accelerate(0.8):addy(-100) end,
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			Def.Sprite {
				Texture = "_uplight",
				InitCommand=function(self) self:CenterX():y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()):blend(Blend.Add) end,
			...
			Def.Sprite {
				Texture = "_uplight",
				InitCommand=function(self) self:CenterX():y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()) end,
			...
			Def.Sprite {
				Texture = "width",
				InitCommand=function(self) self:x(SCREEN_CENTER_X-190*WideScreenDiff()):y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()):halign(1):zoomtowidth(3*WideScreenDiff()) end,
				OnCommand=function(self) self:sleep(1.5):linear(0.1):zoomtowidth(SCREEN_WIDTH/2-200*WideScreenDiff()) end
			},
			Def.Sprite {
				Texture = "width",
				InitCommand=function(self) self:x(SCREEN_CENTER_X+190*WideScreenDiff()):y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()):halign(0):zoomtowidth(3*WideScreenDiff()) end,
				OnCommand=function(self) self:sleep(1.5):linear(0.1):zoomtowidth(SCREEN_WIDTH/2-200*WideScreenDiff()) end
			},
			Def.Sprite {
				Texture = "left",
				InitCommand=function(self) self:x(SCREEN_CENTER_X-193*WideScreenDiff()):y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()):halign(1) end,
				OnCommand=function(self) self:sleep(1.5):linear(0.1):x(SCREEN_LEFT+16*WideScreenDiff()) end
			},
			Def.Sprite {
				Texture = "left",
				InitCommand=function(self) self:x(SCREEN_CENTER_X+193*WideScreenDiff()):y(SCREEN_TOP+24*WideScreenDiff()):zoom(WideScreenDiff()):halign(1):zoomx(-1*WideScreenDiff()) end,
			...
			Def.ActorFrame{
				TitleSongFade:Create()..{
					...
					OnCommand=function(self) self:zoom(0.5*WideScreenDiff()):shadowlength(2*WideScreenDiff()):zoomy(0) if isEtterna("0.65") then self:sleep(2) else self:hibernate(2) end self:decelerate(0.3):zoomy(0.45*WideScreenDiff()) end,
				}
			},
			Def.BitmapText {
				File = "_r bold 30px",
				...
				OnCommand=function(self) self:zoom(0.5*WideScreenDiff()):shadowlength(2*WideScreenDiff()):zoomy(0) if isEtterna("0.65") then self:sleep(2) else self:hibernate(2) end self:decelerate(0.3):zoomy(0.45*WideScreenDiff()):animate(0):playcommand("Update") end,
		...
		Def.ActorFrame{
			...
			Def.Sprite {
				...
				InitCommand=function(self) self:y(SCREEN_TOP+40):blend(Blend.Add) end,
				OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#77777788")):effectcolor2(color("#ffffff")):effectperiod(0.5):effect_hold_at_full(0.5):diffusealpha(0):linear(0.4):diffusealpha(1) end
			},
			Def.Sprite {
				Texture = "_neons bottom",
				InitCommand=function(self) self:y(SCREEN_TOP+40) end,
				OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#ffffffff")):effectperiod(0.5):effect_hold_at_full(0.5):diffusealpha(0):linear(0.4):diffusealpha(1) end
			}
		}
	},
	Def.ActorFrame{
		...
		Def.ActorFrame{
			Condition=not isEtterna("0.65") and (GAMESTATE:IsPlayerEnabled(PLAYER_2) or isVS()),
			Name="Player2",
			OnCommand=function(self) self:x(SCREEN_CENTER_X+240*WideScreenDiff()):y(SCREEN_TOP+27*WideScreenDiff()):zoom(WideScreenDiff()):addx(SCREEN_WIDTH/2) end,
			TweenOnCommand=function(self) self:sleep(1.5):decelerate(0.5):addx(-SCREEN_WIDTH/2) end,
			TweenOffCommand=function(self) self:accelerate(0.8):addx(SCREEN_WIDTH/2) end,
