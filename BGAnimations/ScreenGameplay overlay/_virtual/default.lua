local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight")..{
			...
			OnCommand=cmd(sleep,1.8;linear,.4;diffusealpha,1;);
		};
		LoadActor("width")..{
		...
		LoadActor("_neons")..{
			...
			--effectdelay,0.5;
			OnCommand=cmd(effectclock,'beat';diffuseramp;effectcolor1,color("#77777788");effectcolor2,color("#ffffff");effectperiod,0.5;effectoffset,0.05;diffusealpha,0;linear,.4;diffusealpha,1;);
		};
		LoadActor("_neons")..{
