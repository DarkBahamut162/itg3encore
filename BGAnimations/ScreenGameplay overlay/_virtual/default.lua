local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight")..{
			...
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#77777788")):effectcolor2(color("#ffffff")):effectperiod(1):effectoffset(0):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("_uplight")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP+24) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#ffffffff")):effectperiod(1):effectoffset(0):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("width")..{
		...
		LoadActor("_neons")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP+24):blend(Blend.Add) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#77777788")):effectcolor2(color("#ffffff")):effectperiod(1):effectoffset(0.05):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("_neons")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP+24) end;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#FFFFFF00")):effectcolor2(color("#ffffffff")):effectperiod(1):effectoffset(0.05):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("_neon2")..{
