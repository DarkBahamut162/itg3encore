...
return Def.ActorFrame{
	...
	Def.BitmapText {
		...
		RedrawScoreCommand=function(self)
			...
			MESSAGEMAN:Broadcast("FAScore",{PLAYER=player,TYPE=(scoreType==2 or scoreType==6) and "Percent" or "Score",SCORE=output})
		end,
		OffCommand=function(self)
			if scoreDirection == 2 then scoreDirection = 1 self:queuecommand("RedrawScore") end
			if scoreType == 6 then setenv("WIFE3FA"..pname(player),curwifescore/totalwifescore*W0Percent) end
		end
	}
}