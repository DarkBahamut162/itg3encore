return Def.ActorFrame{
	...
	Def.ActorFrame{
		InitCommand=function(self) self:x(isDouble() and 0 or 79):y(34):visible(GAMESTATE:IsPlayerEnabled(PLAYER_1) and (getenv("IIDXPercent"..pname(PLAYER_1)) or false)) end,
		Def.Sprite {
