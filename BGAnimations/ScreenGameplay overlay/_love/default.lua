local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_uplight")..{
			...
			OnCommand=cmd(sleep,1.8;linear,.4;diffusealpha,1;diffuse,color("#ff5454"));
		};
		LoadActor("width")..{
		...
		LoadActor("_neons")..{
			...
			--effectdelay,0.5;
			OnCommand=cmd(effectclock,'beat';diffuseramp;effectcolor1,color("#4c0a0a");effectcolor2,color("#ff5454");effectperiod,0.5;effectoffset,0.05;diffusealpha,0;linear,.4;diffusealpha,1;);
		};
		LoadActor("_neons")..{
			InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_TOP+24);
			--effectdelay,0.5;
			OnCommand=cmd(effectclock,'beat';diffuseramp;effectcolor1,color("#FFFFFF00");effectcolor2,color("#ff4c4c");effectperiod,0.5;effectoffset,0.05;diffusealpha,0;linear,.4;diffusealpha,1;);
		};
