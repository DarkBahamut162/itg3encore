if getenv("SetScoreFA"..pname(PLAYER_1)) then
	return Def.ActorFrame{
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_sirius/_LEFT_FA"))()..{ InitCommand=function(self) self:x(SCREEN_CENTER_X-185*WideScreenDiff()):y(448):zoom(WideScreenDiff()) end },
