local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("base")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+41) end; };
		LoadActor("_neons")..{
		...
		LoadActor("_neon2")..{
			InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+41):blend(Blend.Add) end;
			--effectdelay,0.5;
			OnCommand=function(self) self:effectclock('beat'):diffuseramp():effectcolor1(color("#680303")):effectcolor2(color("#f11e1e")):effectperiod(1):effectoffset(0.05):diffusealpha(0):linear(.4):diffusealpha(1) end;
		};
		LoadActor("_neon2")..{
