local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("left")..{
			...
			OnCommand=function(self) self:sleep(1.5):linear(.1):x(SCREEN_LEFT) end;
		};
		LoadActor("left")..{
			InitCommand=function(self) self:x(SCREEN_CENTER_X+193):y(SCREEN_TOP-2+24):halign(0):zoomx(-1) end;
			OnCommand=function(self) self:sleep(1.5):linear(.1):x(SCREEN_RIGHT) end;
		};
		LoadActor("base")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+24-2.5) end; };
		LoadActor("bpmbasea")..{ InitCommand=function(self) self:CenterX():y(SCREEN_TOP-2+64-2.5):visible(GAMESTATE:GetPlayMode() ~= 'PlayMode_Rave') end; };
		LoadActor("_neons")..{
