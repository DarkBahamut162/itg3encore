...
if getenv("SetScoreFA"..pname(PLAYER_1)) then
	t[#t+1] = loadfile(THEME:GetPathB("ScreenGameplay","overlay/_gold/_LEFT_FA"))()..{ InitCommand=function(self) self:x(SCREEN_CENTER_X-185*WideScreenDiff()):y(448):zoom(WideScreenDiff()) end }
...
if getenv("SetScoreFA"..pname(PLAYER_2)) then
	t[#t+1] = loadfile(THEME:GetPathB("ScreenGameplay","overlay/_gold/_RIGHT_FA"))()..{ InitCommand=function(self) self:x(SCREEN_CENTER_X+185*WideScreenDiff()):y(448):zoom(WideScreenDiff()) end }
