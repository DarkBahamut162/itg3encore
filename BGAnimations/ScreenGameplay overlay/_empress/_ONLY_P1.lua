if getenv("IIDXDouble"..pname(PLAYER_1)) then
	...
	return Def.ActorFrame{
		loadfile(THEME:GetPathB("ScreenGameplay","overlay/_empress/_LEFT_SCORE"))()..{ InitCommand=function(self) self:x(SCREEN_CENTER_X-185*WideScreenDiff()):y(448):zoom(WideScreenDiff()) end },
