        ...
        Def.BitmapText{
            ...
            InitCommand=function(self)
                ...
                if screenCheck and GetScreenAspectRatio() > 1 then
                    self:x(player == PLAYER_1 and -graphH*1.525 or graphH*1.525):y(graphH*(isFinal() and -2.1 or 2.1)):zoomx((player == PLAYER_1 and not IsNetSMOnline()) and -1 or 1):maxwidth(graphH):halign(IsNetSMOnline() and 1 or 0):valign(isFinal() and 1 or 0)
                else
