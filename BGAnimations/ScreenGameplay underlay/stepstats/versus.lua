return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			BeginCommand=function(self) self:visible(GAMESTATE:IsHumanPlayer(PLAYER_1) and getenv("ShowStatsP1") or false) end;
		...
		Def.ActorFrame{
			...
			BeginCommand=function(self) self:visible(GAMESTATE:IsHumanPlayer(PLAYER_2) and getenv("ShowStatsP2") or false) end;
			OnCommand=function(self) self:sleep(0.5):decelerate(0.8):addx(-100) end;
			OffCommand=function(self) if AnyPlayerFullComboed() then self:sleep(1) end; self:accelerate(0.8):addx(100) end;
	...
	Def.ActorFrame{
		...
		BeginCommand=function(self) self:visible(getenv("ShowStatsP1") or getenv("ShowStatsP2") or false) end;
