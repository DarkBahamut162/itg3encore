return Def.ActorFrame{
	Def.Sprite {
		Texture = "Intro by Angel",
		InitCommand=function(self) self:FullScreen():zoomy(1.2):rate(0.92):sleep(35):diffusealpha(0) end
	},
	Def.ActorFrame{
		InitCommand=function(self) self:Center() end,
		Def.Sprite {
			Texture = "swoosh "..(isFinal() and "final" or "normal"),
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			Def.ActorFrame{
				Def.Sprite {
					Texture = THEME:GetPathB("ScreenTitleMenu","background/_topright"),
				...
				Def.Sprite {
					Texture = THEME:GetPathB("ScreenTitleMenu","background/_center"),
					InitCommand=function(self) self:FullScreen():blend(Blend.Add):diffusealpha(0) end,
				...
				Def.Sprite {
					Texture = THEME:GetPathB("ScreenTitleMenu","background/_2top"),
					InitCommand=function(self) self:FullScreen():blend(Blend.Add):diffusealpha(0) end,
				...
				Def.Sprite {
					Texture = THEME:GetPathB("ScreenTitleMenu","background/_left"),
					InitCommand=function(self) self:FullScreen():blend(Blend.Add):diffusealpha(0) end,
				...
				Def.Sprite {
					Texture = THEME:GetPathB("ScreenTitleMenu","background/_right"),
					InitCommand=function(self) self:FullScreen():blend(Blend.Add):diffusealpha(0) end,
				...
				Def.Sprite {
					Texture = THEME:GetPathB("ScreenTitleMenu","background/_2center"),
					InitCommand=function(self) self:FullScreen():blend(Blend.Add):diffusealpha(0) end,
					OnCommand=function(self) self:cropright(-0.8):cropleft(1):fadeleft(0.45):faderight(0.45):sleep(0.4):diffusealpha(1):linear(3):cropright(1):cropleft(-0.8):sleep(0.2) end
				}
			}
		...
		Def.Sprite {
			Texture = THEME:GetPathB("ScreenTitleMenu","background/glow "..(isFinal() and "final" or "normal")),
		...
		Def.Sprite {
			Texture = THEME:GetPathB("ScreenTitleMenu","background/light "..(isFinal() and "final" or "normal")),
	...
	loadfile(THEME:GetPathB("ScreenIntro","background/songs"))(),
	loadfile(THEME:GetPathB("ScreenIntro","background/charts"))(),
	loadfile(THEME:GetPathB("ScreenIntro","background/courses"))(),
	loadfile(THEME:GetPathB("ScreenIntro","background/mods"))(),
	Def.Quad{
