return Def.ActorFrame{
	...
	Def.Sprite {
		Texture = THEME:GetPathB("","_thanks/_openddr/logo"),
	...
	Def.Sprite {
		Texture = THEME:GetPathB("","_thanks/_openddr/text"),
		OnCommand=function(self) self:x(100):zoomto(440,91) end
	},
	Def.Sprite {
		Texture = THEME:GetPathB("","_thanks/_openddr/text"),
		Name="TextGlow",
		InitCommand=function(self) self:blend(Blend.Add):diffusealpha(0.05) end,
		OnCommand=function(self) self:x(100):zoomto(440,91):glowshift():effectperiod(2.5):effectcolor1(color("1,1,1,0.25")):effectcolor2(color("1,1,1,1")) end
	},
	Def.BitmapText {
		File = "_v profile",
		Text="Powered by",
	...
	Def.BitmapText {
		...
		Text="https://github.com/h-lunah/stepmania-ddr",
