return Def.ActorFrame{
	...
	LoadActor(THEME:GetPathB("","_thanks/_itgmania/logo"))..{
	...
	LoadActor(THEME:GetPathB("","_thanks/_itgmania/text"))..{
		OnCommand=function(self) self:x(112):zoomto(440,110) end
	},
	LoadActor(THEME:GetPathB("","_thanks/_itgmania/text"))..{
		Name="TextGlow",
		InitCommand=function(self) self:blend(Blend.Add):diffusealpha(0.05) end,
		OnCommand=function(self) self:x(112):zoomto(440,110):glowshift():effectperiod(2.5):effectcolor1(color("1,1,1,0.25")):effectcolor2(color("1,1,1,1")) end
	},
	LoadFont("_v profile")..{
		Text="Powered by",
