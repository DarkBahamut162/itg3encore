return Def.ActorFrame{
	LoadActor(THEME:GetPathB("ScreenTitleMenu","background/glow"))..{
		InitCommand=function(self) self:zoom(.8):diffusealpha(0) end;
		OnCommand=function(self) self:sleep(.2):linear(.4):diffusealpha(1):zoom(1):sleep(1.5) end;
	};
	LoadActor(THEME:GetPathB("ScreenTitleMenu","background/glow"))..{
		InitCommand=function(self) self:blend(Blend.Add):zoom(1):diffusealpha(0) end;
		OnCommand=function(self) self:sleep(.4):accelerate(.3):diffusealpha(.4):linear(1.8):zoom(1.4):diffusealpha(0) end;
	};
	LoadActor(THEME:GetPathB("ScreenTitleMenu","background/light"))..{
		...
		OnCommand=function(self) self:linear(1):cropright(-0.2):cropleft(-0.3):cropright(1):faderight(.1):fadeleft(.1):sleep(.4):linear(0.7):cropleft(1):cropright(-0.3):sleep(0.5) end;
	};
