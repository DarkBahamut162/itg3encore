...
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Ryan McKanna"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Matt Puls"}
...
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Dominick Renzetti"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Jordan Frederick"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Mike Calfin"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Ryan Konkul"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Kyle Ward"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Chris Foy"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Ryan McKanna"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Matt Puls"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Jonas Casarino"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Christopher Emirzian"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Eric Holniker"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="A.J. Kung"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Max Leonardo Cerna"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Joseph DeGarmo"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Alex Sofikitis"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="N. Colley"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="J. Nordli"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Justin Pagano"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="M.J. Quigley"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Derek Bauer"}
...
credits[#credits+1] = Def.ActorFrame{}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="PressX"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="KholdFuzion"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="AJ 197"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Infamouspat"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="vdl"}
...
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Hellacious"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Kalek"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Lightning"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="NX-306"}
...
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="SonGohanX"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Rubbinnexx"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Kung"}
...
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="North Park Club House - PA"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Game Zone - KS"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="TownMall - MD"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Corner Pocket - PA"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Funland - Trocadero Centre, UK"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Family Fun Center - PA"}
...
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Mike Porter"}
credits[#credits+1] = Def.BitmapText { File = "_r bold 30px", Text="Michael Phillips"}
