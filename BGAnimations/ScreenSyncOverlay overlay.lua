...
return Def.ActorFrame{
	Def.Quad{
		Name="quad",
		InitCommand=function(self) self:diffuse{0, 0, 0, 0}:horizalign(right):vertalign(top):xy(_screen.w, 0) end,
		ShowCommand=function(self) self:stoptweening():linear(.3):diffusealpha(.5):sleep(4):linear(.3):diffusealpha(0) end,
		HideCommand=function(self) self:finishtweening() end
	},
	Def.BitmapText{
		Name="help_text",
		Font="Common Normal",
	...
	Def.BitmapText{
		...
		SetStatusCommand=function(self, param) self:settext(param.text) end
	},
	Def.BitmapText{
		Name="Adjustments",
		...
		SetAdjustmentsCommand=function(self, param) self:visible(param.visible):settext(param.text) end
	}
}
