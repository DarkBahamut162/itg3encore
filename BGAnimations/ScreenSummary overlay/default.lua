...
for i=1,rounds do
	if ThemePrefs.Get("ShowSummarySummary") then
		...
		if ThemePrefs.Get("ShowTime") and P1[i] and P1[i]["TotalTime"] then Master[rounds+1]["TotalTimeP1"] = (Master[rounds+1]["TotalTimeP1"] or 0) + P1[i]["TotalTime"] end
		if ThemePrefs.Get("ShowTime") and P2[i] and P2[i]["TotalTime"] then Master[rounds+1]["TotalTimeP2"] = (Master[rounds+1]["TotalTimeP2"] or 0) + P2[i]["TotalTime"] end
		if version <= 2 and P1[i] and not P1[i]["AutoPlayer"] then
			...
			if ThemePrefs.Get("ShowTime") then P1[rounds+1]["PlayedTime"] = (P1[rounds+1]["PlayedTime"] or 0) + P1[i]["PlayedTime"] end
		...
		if version >= 2 and P2[i] and not P2[i]["AutoPlayer"] then
			...
			if ThemePrefs.Get("ShowTime") then P2[rounds+1]["PlayedTime"] = (P2[rounds+1]["PlayedTime"] or 0) + P2[i]["PlayedTime"] end
