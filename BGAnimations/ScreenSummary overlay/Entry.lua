...
if version < 3 then
    if P1[index] then
        playerScore[#playerScore+1] = Def.ActorFrame{
            Name="BannerAreaP1",
            OnCommand=function(self) if P1[index]["AutoPlayer"] then self:RunCommandsOnChildren(function(self) self:diffusealpha(0.5) end) end end,
            Def.BitmapText {
                File = "_z bold 36px",
                Text = P1[index]["Meter"],
            ...
            Def.BitmapText {
                Condition = P1[index]["AutoPlayer"],
                File = "_z bold 36px",
                Text = "AutoPlayer",
                InitCommand=function(self)
                    self:shadowlength(1):diffuseshift():effectcolor1(color("1,0,0,1")):effectcolor2(color("1,0,0,0.5")):effectperiod(1)
                    if version == 2 then
                        self:x(scale(0.5,0,1,borderLeft,version==1 and borderRight or borderLeftCenter)):rotationz(90/16):zoomx(0.4*WideScreenDiff()):zoomy(0.5*WideScreenDiff())
                    else
                        self:x(scale(0.5,0,1,borderLeft,version==1 and borderRight or borderLeftCenter)):rotationz(90/16):zoom(0.5*WideScreenDiff())
                    end
                end,
        ...
        playerScore[#playerScore+1] = Def.ActorFrame{
            Def.BitmapText {
                ...
                InitCommand=function(self)
                    self:shadowlength(1):diffuseshift():effectcolor1(color("1,0,0,1")):effectcolor2(color("1,0,0,0.5")):effectperiod(1)
                    if version == 2 then
                        self:x(scale(0.5,0,1,borderLeft,version==1 and borderRight or borderLeftCenter)):rotationz(90/16):zoomx(0.25*WideScreenDiff()):zoomy(0.5*WideScreenDiff())
                    else
                        self:x(scale(0.5,0,1,borderLeft,version==1 and borderRight or borderLeftCenter)):rotationz(90/16):zoom(0.5*WideScreenDiff())
                    end
                end,
...
if version > 1 then
    if P2[index] then
        playerScore[#playerScore+1] = Def.ActorFrame{
            Name="BannerAreaP2",
            OnCommand=function(self) if P2[index]["AutoPlayer"] then self:RunCommandsOnChildren(function(self) self:diffusealpha(0.5) end) end end,
            Def.BitmapText {
                File = "_z bold 36px",
                Text = P2[index]["Meter"],
                InitCommand=function(self)
            ...
            Def.BitmapText {
                Condition = P2[index]["AutoPlayer"],
                File = "_z bold 36px",
                Text = "AutoPlayer",
                InitCommand=function(self)
                    self:shadowlength(1):diffuseshift():effectcolor1(color("1,0,0,1")):effectcolor2(color("1,0,0,0.5")):effectperiod(1)
                    if version == 2 then
                        self:x(scale(0.5,0,1,version==3 and borderLeft or borderRightCenter,borderRight)):rotationz(90/16):zoom(0.4*WideScreenDiff())
                    else
                        self:x(scale(0.5,0,1,version==3 and borderLeft or borderRightCenter,borderRight)):rotationz(90/16):zoom(0.5*WideScreenDiff())
                    end
                end,
                OnCommand=function(self) self:diffusealpha(1) end
            }
        ...
        playerScore[#playerScore+1] = Def.ActorFrame{
            Def.BitmapText {
                ...
                InitCommand=function(self)
                    self:shadowlength(1):diffuseshift():effectcolor1(color("1,0,0,1")):effectcolor2(color("1,0,0,0.5")):effectperiod(1)
                    if version == 2 then
                        self:x(scale(0.5,0,1,version==3 and borderLeft or borderRightCenter,borderRight)):rotationz(90/16):zoomx(0.25*WideScreenDiff()):zoomy(0.5*WideScreenDiff())
                    else
                        self:x(scale(0.5,0,1,version==3 and borderLeft or borderRightCenter,borderRight)):rotationz(90/16):zoom(0.5*WideScreenDiff())
                    end
                end,
